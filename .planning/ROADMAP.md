...
**Depends on:** v1.0 MVP
**Status:** Complete — verified 2026-03-18
**Plans:** 3/3 plans complete

Plans:
- [x] 01-01-PLAN.md — Fix production bugs: backoff dead code, backoff reset, buffer warning rate-limit
- [x] 01-02-PLAN.md — Fix test mocks, adopt OTel test helpers, add config validation
- [x] 01-03-PLAN.md — Add CI lint, LICENSE, go:generate directive, documentation
